...
class LibraryWindow(QtWidgets.QWidget):
    ...
    DEFAULT_SETTINGS = {
        ...
        "defaultRelativeObject": "ctrl_c_rootFollow",
        "theme": {
    ...
    def __init__(self, parent=None, name="", path=""):
        ...
        self._theme = None
        self._kwargs = {}
        self._defaultRelativeObject = self.DEFAULT_SETTINGS["defaultRelativeObject"]
        self._isDebug = False
    ...
    def settingsAccepted(self, **kwargs):
        ...
        self.setDefaultRelativeObject(kwargs.get("defaultRelativeObject", ""))

        self.saveSettings()

    def defaultRelativeObject(self):
        """Return the namespace-free name used as a relative pose anchor."""
        return self._defaultRelativeObject

    def setDefaultRelativeObject(self, name):
        """Set the namespace-free name used as a relative pose anchor."""
        self._defaultRelativeObject = (name or "").strip()
    ...
    def showSettingDialog(self):
        ...
        form = {
            ...
            "schema": [
                ...
                {
                    "name": "defaultRelativeObject",
                    "title": "Default Relative Object",
                    "type": "string",
                    "value": self.defaultRelativeObject(),
                    "placeholder": "ctrl_c_rootFollow",
                    "toolTip": "Name only; the selected control's namespace is "
                               "added automatically when saving a Relative pose.",
                },
                {
                    "name": "accentColor",
                    "type": "color",
    ...
    def settings(self):
        ...
        settings["defaultRelativeObject"] = self.defaultRelativeObject()
    ...
    def setSettings(self, settings):
        ...
        try:
            ...
            self.setDefaultRelativeObject(settings.get("defaultRelativeObject", ""))
